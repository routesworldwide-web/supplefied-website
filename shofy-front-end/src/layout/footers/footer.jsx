              ...
              <div className="col-xl-4 col-lg-3 col-md-4 col-sm-6">
                <div className="tp-footer-widget footer-col-1 mb-50">
                  <div className="tp-footer-widget-content">
                    ...
                    <p className="tp-footer-desc">Your trusted source for premium supplements and nutritional products. Quality, integrity, and your wellness is our commitment.</p>
                    ...
                    <div className="tp-footer-contact">
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="mailto:support@supplefied.com">support@supplefied.com</a></p>
                        </div>
                      </div>
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        <div className="tp-footer-contact-icon">
              ...
              <div className="row align-items-center">
                <div className="col-md-6">
                  <div className="tp-footer-copyright">
                    <p>© {new Date().getFullYear()} Supplefied. All Rights Reserved. Premium Supplements Store.
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
