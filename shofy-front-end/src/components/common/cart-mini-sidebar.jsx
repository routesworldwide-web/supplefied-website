...
import { formatPrice, getProductUnitPrice } from '@/utils/pricing';
        ...
        <div className="cartmini__wrapper d-flex justify-content-between flex-column">
                ...
                <div key={i} className="cartmini__widget-item">
                  ...
                  <div className="cartmini__content">
                    <h5 className="cartmini__title">
                      <Link href={getProductDetailsUrl(item)}>{item.title}</Link>
                    </h5>
                    <div className="cartmini__price-wrapper">
                      <span className="cartmini__price">{formatPrice(getProductUnitPrice(item))}</span>
          ...
          <div className="cartmini__checkout">
            ...
            <div className="cartmini__checkout-btn">
              <Link href="/cart" onClick={handleCloseCartMini} className="tp-btn mb-10 w-100 text-light"> view cart</Link>
